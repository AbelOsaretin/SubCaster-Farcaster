...
class NeynarV2APIClient {
    ...
    constructor(apiKey, { basePath, logger = logger_1.silentLogger, axiosInstance, } = {}) {
        ...
        const frameConfig = new openapi_farcaster_1.Configuration(Object.assign(Object.assign({}, config), { baseOptions: Object.assign(Object.assign({}, config.baseOptions), { maxRedirects: 0 }) }));
        this.apis = {
            ...
            frame: new openapi_farcaster_1.FrameApi(frameConfig, undefined, axiosInstance),
            ...
            subscribers: new openapi_farcaster_1.SubscribersApi(config, undefined, axiosInstance),
        };
    }
    /**
    ...
    */
    ...
    async fetchPowerUsers(options) {
        const response = await this.apis.user.powerUsers(this.apiKey, options === null || options === void 0 ? void 0 : options.viewerFid, options === null || options === void 0 ? void 0 : options.limit, options === null || options === void 0 ? void 0 : options.cursor);
        return response.data;
    }
    /**
    ...
    async fetchBulkUsersByEthereumAddress(addresses, options) {
        ...
        const response = await this.apis.user.userBulkByAddress(this.apiKey, _addresses, _addressTypes, options === null || options === void 0 ? void 0 : options.viewerFid);
        return response.data;
    }
    /**
     ...
     */
    async lookUpCastByHashOrWarpcastUrl(castHashOrUrl, type, options) {
        const response = await this.apis.cast.cast(this.apiKey, castHashOrUrl, type, options === null || options === void 0 ? void 0 : options.viewerFid);
        return response.data;
    }
    /**
    ...
    async publishCast(signerUuid, text, options) {
        const postCastReqBody = {
            ...
            idem: options === null || options === void 0 ? void 0 : options.idem,
            parent_author_fid: options === null || options === void 0 ? void 0 : options.parent_author_fid
        };
    ...
    async fetchFeedByChannelIds(channelIds, options) {
        ...
        const response = await this.apis.feed.feedChannels(this.apiKey, _channelIds, options === null || options === void 0 ? void 0 : options.withRecasts, options === null || options === void 0 ? void 0 : options.viewerFid, options === null || options === void 0 ? void 0 : options.withReplies, options === null || options === void 0 ? void 0 : options.limit, options === null || options === void 0 ? void 0 : options.cursor, options === null || options === void 0 ? void 0 : options.shouldModerate);
        return response.data;
    }
    /**
     ...
     * For more information, refer to the [Neynar documentation](https://docs.neynar.com/reference/feed-following).
     */
    async fetchFeedForYou(fid, options) {
        const response = await this.apis.feed.feedForYou(this.apiKey, fid, options === null || options === void 0 ? void 0 : options.viewerFid, options === null || options === void 0 ? void 0 : options.provider, options === null || options === void 0 ? void 0 : options.limit, options === null || options === void 0 ? void 0 : options.cursor);
        return response.data;
    }
    /**
     ...
     */
    async publishReactionToCast(signerUuid, reaction, castOrCastHash, options) {
        let castHash;
        if (typeof castOrCastHash === "string") {
            castHash = castOrCastHash;
        }
    ...
    async fetchUserReactions(fid, type, options) {
        const response = await this.apis.reaction.reactionsUser(this.apiKey, fid, type, options === null || options === void 0 ? void 0 : options.viewerFid, options === null || options === void 0 ? void 0 : options.limit, options === null || options === void 0 ? void 0 : options.cursor);
        return response.data;
    }
    /**
    ...
    async fetchCastReactions(hash, types, options) {
        const response = await this.apis.reaction.reactionsCast(this.apiKey, hash, types, options === null || options === void 0 ? void 0 : options.viewerFid, options === null || options === void 0 ? void 0 : options.limit, options === null || options === void 0 ? void 0 : options.cursor);
        return response.data;
    }
    // ------------ Notifications ------------
    /**
    ...
    async fetchAllNotifications(fid, options) {
        const response = await this.apis.notifications.notifications(this.apiKey, fid, options === null || options === void 0 ? void 0 : options.cursor, options === null || options === void 0 ? void 0 : options.isPriority);
        return response.data;
    }
    /**
    ...
    async fetchChannelNotificationsForUser(fid, channelIds, options) {
        const _channelIds = channelIds.join(",");
        const response = await this.apis.notifications.notificationsChannel(this.apiKey, fid, _channelIds, options === null || options === void 0 ? void 0 : options.cursor, options === null || options === void 0 ? void 0 : options.isPriority);
        return response.data;
    }
    /**
    ...
    async fetchNotificationsByParentUrlForUser(fid, parentUrls, options) {
        ...
        const response = await this.apis.notifications.notificationsParentUrl(this.apiKey, fid, _parentUrls, options === null || options === void 0 ? void 0 : options.cursor, options === null || options === void 0 ? void 0 : options.isPriority);
        return response.data;
    }
    // ------------ Channel ------------
    /**
   ...
   */
    ...
    */
    async fetchBulkChannels(ids, options) {
        const _ids = ids.join(",");
        const response = await this.apis.channel.channelDetailsBulk(this.apiKey, _ids, options === null || options === void 0 ? void 0 : options.type, options === null || options === void 0 ? void 0 : options.viewerFid);
        return response.data;
    }
    /**
    ...
    async lookupChannel(id, options) {
        const response = await this.apis.channel.channelDetails(this.apiKey, id, options === null || options === void 0 ? void 0 : options.type, options === null || options === void 0 ? void 0 : options.viewerFid);
        return response.data;
    }
    /**
    ...
    */
    async fetchUserFollowersV2(fid, options) {
        const response = await this.apis.follows.followersV2(this.apiKey, fid, options === null || options === void 0 ? void 0 : options.viewerFid, options === null || options === void 0 ? void 0 : options.sortType, options === null || options === void 0 ? void 0 : options.limit, options === null || options === void 0 ? void 0 : options.cursor);
        return response.data;
    }
    /**
    ...
    */
    async fetchUserFollowingV2(fid, options) {
        const response = await this.apis.follows.followingV2(this.apiKey, fid, options === null || options === void 0 ? void 0 : options.viewerFid, options === null || options === void 0 ? void 0 : options.sortType, options === null || options === void 0 ? void 0 : options.limit, options === null || options === void 0 ? void 0 : options.cursor);
        return response.data;
    }
    // ------------ Storage ------------
    /**
     ...
     */
    async lookupNeynarFrame(identifier, options) {
        const type = (options === null || options === void 0 ? void 0 : options.type) || openapi_farcaster_1.FrameType.Uuid;
        const response = await this.apis.frame.lookupNeynarFrame(this.apiKey, type, type === openapi_farcaster_1.FrameType.Uuid ? identifier : undefined, type === openapi_farcaster_1.FrameType.Url ? identifier : undefined);
        return response.data;
    }
    /**
    ...
    */
    ...
    /**
          ...
          */
    async fetchSubscribersForFid(fid, subscriptionProvider, options) {
        const response = await this.apis.subscribers.subscribers(this.apiKey, fid, subscriptionProvider, options === null || options === void 0 ? void 0 : options.viewerFid);
        return response.data;
    }
    /**
      ...
      */
    async fetchSubscribedToForFid(fid, subscriptionProvider, options) {
        const response = await this.apis.subscribers.subscribedTo(this.apiKey, fid, subscriptionProvider, options === null || options === void 0 ? void 0 : options.viewerFid);
        return response.data;
    }
    /**
            ...
            */
    async fetchSubscriptionsForFid(fid, subscriptionProvider) {
