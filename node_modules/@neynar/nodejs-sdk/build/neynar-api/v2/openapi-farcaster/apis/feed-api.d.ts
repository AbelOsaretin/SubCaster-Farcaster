...
export declare const FeedApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    feedChannels: (apiKey: string, channelIds: string, withRecasts?: boolean, viewerFid?: number, withReplies?: boolean, limit?: number, cursor?: string, shouldModerate?: boolean, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    feedForYou: (apiKey: string, fid: number, viewerFid?: number, provider?: ForYouProvider, limit?: number, cursor?: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    feedTrending: (apiKey: string, limit?: number, cursor?: string, viewerFid?: number, timeWindow?: '1h' | '6h' | '12h' | '24h' | '7d', channelId?: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
...
export declare const FeedApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    feedChannels(apiKey: string, channelIds: string, withRecasts?: boolean, viewerFid?: number, withReplies?: boolean, limit?: number, cursor?: string, shouldModerate?: boolean, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FeedResponse>>;
    /**
     * Retrieve feed based on who a user is following
     * @summary Retrieve feed based on who a user is following
     * @param {string} apiKey API key required for authentication.
     ...
     * @throws {RequiredError}
     */
    feedForYou(apiKey: string, fid: number, viewerFid?: number, provider?: ForYouProvider, limit?: number, cursor?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FeedResponse>>;
    /**
     * Retrieve feed of casts with Frames, reverse chronological order
     * @summary Retrieve feed of casts with Frames, reverse chronological order
     * @param {string} apiKey API key required for authentication.
     ...
     * @throws {RequiredError}
     */
    feedTrending(apiKey: string, limit?: number, cursor?: string, viewerFid?: number, timeWindow?: '1h' | '6h' | '12h' | '24h' | '7d', channelId?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FeedResponse>>;
    /**
     * Retrieve 10 most popular casts for a given user FID; popularity based on replies, likes and recasts; sorted by most popular first
     * @summary Retrieve 10 most popular casts for a user
     * @param {string} apiKey API key required for authentication.
...
export declare class FeedApi extends BaseAPI {
     ...
     * @memberof FeedApi
     */
    feedChannels(apiKey: string, channelIds: string, withRecasts?: boolean, viewerFid?: number, withReplies?: boolean, limit?: number, cursor?: string, shouldModerate?: boolean, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<FeedResponse, any>>;
    /**
     * Retrieve feed based on who a user is following
     * @summary Retrieve feed based on who a user is following
     * @param {string} apiKey API key required for authentication.
     ...
     * @memberof FeedApi
     */
    feedForYou(apiKey: string, fid: number, viewerFid?: number, provider?: ForYouProvider, limit?: number, cursor?: string, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<FeedResponse, any>>;
    /**
     * Retrieve feed of casts with Frames, reverse chronological order
     * @summary Retrieve feed of casts with Frames, reverse chronological order
     * @param {string} apiKey API key required for authentication.
     ...
     * @memberof FeedApi
     */
    feedTrending(apiKey: string, limit?: number, cursor?: string, viewerFid?: number, timeWindow?: '1h' | '6h' | '12h' | '24h' | '7d', channelId?: string, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<FeedResponse, any>>;
    /**
     * Retrieve 10 most popular casts for a given user FID; popularity based on replies, likes and recasts; sorted by most popular first
     * @summary Retrieve 10 most popular casts for a user
     * @param {string} apiKey API key required for authentication.
