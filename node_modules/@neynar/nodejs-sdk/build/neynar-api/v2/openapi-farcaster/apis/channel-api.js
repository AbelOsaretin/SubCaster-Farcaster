...
const ChannelApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        channelDetails: async (apiKey, id, type, viewerFid, options = {}) => {
            // verify required parameter 'apiKey' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        channelDetailsBulk: async (apiKey, ids, type, viewerFid, options = {}) => {
            // verify required parameter 'apiKey' is not null or undefined
            (0, common_1.assertParamExists)('channelDetailsBulk', 'apiKey', apiKey);
            // verify required parameter 'ids' is not null or undefined
            (0, common_1.assertParamExists)('channelDetailsBulk', 'ids', ids);
...
const ChannelApiFp = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async channelDetails(apiKey, id, type, viewerFid, options) {
         ...
         * @throws {RequiredError}
         */
        async channelDetailsBulk(apiKey, ids, type, viewerFid, options) {
...
const ChannelApiFactory = function (configuration, basePath, axios) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        channelDetails(apiKey, id, type, viewerFid, options) {
         ...
         * @throws {RequiredError}
         */
        channelDetailsBulk(apiKey, ids, type, viewerFid, options) {
...
class ChannelApi extends base_1.BaseAPI {
     ...
     */
    channelDetails(apiKey, id, type, viewerFid, options) {
        return (0, exports.ChannelApiFp)(this.configuration).channelDetails(apiKey, id, type, viewerFid, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Returns details of multiple channels
     * @summary (Bulk) Retrieve channels by id or parent_url
     ...
     */
    channelDetailsBulk(apiKey, ids, type, viewerFid, options) {
        return (0, exports.ChannelApiFp)(this.configuration).channelDetailsBulk(apiKey, ids, type, viewerFid, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Returns a list of followers for a specific channel. Max limit is 1000. Use cursor for pagination.
     * @summary Retrieve followers for a given channel
