...
const NotificationsApiAxiosParamCreator = function (configuration) {
    return {
         ...
         */
        notifications: async (apiKey, fid, cursor, isPriority, options = {}) => {
         ...
         * @throws {RequiredError}
         */
        notificationsChannel: async (apiKey, fid, channelIds, cursor, isPriority, options = {}) => {
            // verify required parameter 'apiKey' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        notificationsParentUrl: async (apiKey, fid, parentUrls, cursor, isPriority, options = {}) => {
            // verify required parameter 'apiKey' is not null or undefined
...
const NotificationsApiFp = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async notifications(apiKey, fid, cursor, isPriority, options) {
         ...
         * @throws {RequiredError}
         */
        async notificationsChannel(apiKey, fid, channelIds, cursor, isPriority, options) {
         ...
         * @throws {RequiredError}
         */
        async notificationsParentUrl(apiKey, fid, parentUrls, cursor, isPriority, options) {
...
const NotificationsApiFactory = function (configuration, basePath, axios) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        notifications(apiKey, fid, cursor, isPriority, options) {
         ...
         * @throws {RequiredError}
         */
        notificationsChannel(apiKey, fid, channelIds, cursor, isPriority, options) {
         ...
         * @throws {RequiredError}
         */
        notificationsParentUrl(apiKey, fid, parentUrls, cursor, isPriority, options) {
...
class NotificationsApi extends base_1.BaseAPI {
     ...
     */
    notifications(apiKey, fid, cursor, isPriority, options) {
        return (0, exports.NotificationsApiFp)(this.configuration).notifications(apiKey, fid, cursor, isPriority, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Returns a list of notifications for a user in specific channels
     * @summary Retrieve notifications for a user in given channels
     ...
     */
    notificationsChannel(apiKey, fid, channelIds, cursor, isPriority, options) {
        return (0, exports.NotificationsApiFp)(this.configuration).notificationsChannel(apiKey, fid, channelIds, cursor, isPriority, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Returns a list of notifications for a user in specific parent_urls
     * @summary Retrieve notifications for a user in given parent_urls
     ...
     */
    notificationsParentUrl(apiKey, fid, parentUrls, cursor, isPriority, options) {
        return (0, exports.NotificationsApiFp)(this.configuration).notificationsParentUrl(apiKey, fid, parentUrls, cursor, isPriority, options).then((request) => request(this.axios, this.basePath));
    }
}
