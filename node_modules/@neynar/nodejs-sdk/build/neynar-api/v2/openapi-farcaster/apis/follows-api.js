...
const FollowsApiAxiosParamCreator = function (configuration) {
    return {
         ...
         */
        followersV2: async (apiKey, fid, viewerFid, sortType, limit, cursor, options = {}) => {
            // verify required parameter 'apiKey' is not null or undefined
            (0, common_1.assertParamExists)('followersV2', 'apiKey', apiKey);
            // verify required parameter 'fid' is not null or undefined
            (0, common_1.assertParamExists)('followersV2', 'fid', fid);
         ...
         * @throws {RequiredError}
         */
        followingV2: async (apiKey, fid, viewerFid, sortType, limit, cursor, options = {}) => {
            // verify required parameter 'apiKey' is not null or undefined
            (0, common_1.assertParamExists)('followingV2', 'apiKey', apiKey);
            // verify required parameter 'fid' is not null or undefined
            (0, common_1.assertParamExists)('followingV2', 'fid', fid);
...
const FollowsApiFp = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async followersV2(apiKey, fid, viewerFid, sortType, limit, cursor, options) {
         ...
         * @throws {RequiredError}
         */
        async followingV2(apiKey, fid, viewerFid, sortType, limit, cursor, options) {
...
const FollowsApiFactory = function (configuration, basePath, axios) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        followersV2(apiKey, fid, viewerFid, sortType, limit, cursor, options) {
         ...
         * @throws {RequiredError}
         */
        followingV2(apiKey, fid, viewerFid, sortType, limit, cursor, options) {
...
class FollowsApi extends base_1.BaseAPI {
     ...
     */
    followersV2(apiKey, fid, viewerFid, sortType, limit, cursor, options) {
        return (0, exports.FollowsApiFp)(this.configuration).followersV2(apiKey, fid, viewerFid, sortType, limit, cursor, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Retrieve a list of users followed by a user. Can optionally include a viewer_fid and sort_type.
     * @summary Retrieve a list of users followed by a user
     ...
     */
    followingV2(apiKey, fid, viewerFid, sortType, limit, cursor, options) {
        return (0, exports.FollowsApiFp)(this.configuration).followingV2(apiKey, fid, viewerFid, sortType, limit, cursor, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Returns a list of relevant followers for a specific FID.
     * @summary Retrieve relevant followers for a given user
