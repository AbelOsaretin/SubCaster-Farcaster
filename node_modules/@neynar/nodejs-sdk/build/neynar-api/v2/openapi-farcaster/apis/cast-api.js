...
const CastApiAxiosParamCreator = function (configuration) {
    return {
         ...
         */
        cast: async (apiKey, identifier, type, viewerFid, options = {}) => {
            // verify required parameter 'apiKey' is not null or undefined
            (0, common_1.assertParamExists)('cast', 'apiKey', apiKey);
            // verify required parameter 'identifier' is not null or undefined
            (0, common_1.assertParamExists)('cast', 'identifier', identifier);
            // verify required parameter 'type' is not null or undefined
            (0, common_1.assertParamExists)('cast', 'type', type);
         ...
         * @throws {RequiredError}
         */
        castConversation: async (apiKey, identifier, type, replyDepth, includeChronologicalParentCasts, viewerFid, limit, cursor, options = {}) => {
            // verify required parameter 'apiKey' is not null or undefined
            (0, common_1.assertParamExists)('castConversation', 'apiKey', apiKey);
            // verify required parameter 'identifier' is not null or undefined
            (0, common_1.assertParamExists)('castConversation', 'identifier', identifier);
            // verify required parameter 'type' is not null or undefined
            (0, common_1.assertParamExists)('castConversation', 'type', type);
         ...
         * @throws {RequiredError}
         */
        deleteCast: async (apiKey, deleteCastReqBody, options = {}) => {
            // verify required parameter 'apiKey' is not null or undefined
            (0, common_1.assertParamExists)('deleteCast', 'apiKey', apiKey);
         ...
         * @throws {RequiredError}
         */
        postCast: async (apiKey, postCastReqBody, options = {}) => {
            // verify required parameter 'apiKey' is not null or undefined
            (0, common_1.assertParamExists)('postCast', 'apiKey', apiKey);
            // verify required parameter 'postCastReqBody' is not null or undefined
            (0, common_1.assertParamExists)('postCast', 'postCastReqBody', postCastReqBody);
            const localVarPath = `/farcaster/cast`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, common_1.DUMMY_BASE_URL);
            let baseOptions;
...
const CastApiFp = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async cast(apiKey, identifier, type, viewerFid, options) {
         ...
         * @throws {RequiredError}
         */
        async castConversation(apiKey, identifier, type, replyDepth, includeChronologicalParentCasts, viewerFid, limit, cursor, options) {
         ...
         * @throws {RequiredError}
         */
        async casts(apiKey, casts, viewerFid, sortType, options) {
         ...
         * @throws {RequiredError}
         */
        async deleteCast(apiKey, deleteCastReqBody, options) {
         ...
         * @throws {RequiredError}
         */
        async postCast(apiKey, postCastReqBody, options) {
...
const CastApiFactory = function (configuration, basePath, axios) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        cast(apiKey, identifier, type, viewerFid, options) {
         ...
         * @throws {RequiredError}
         */
        castConversation(apiKey, identifier, type, replyDepth, includeChronologicalParentCasts, viewerFid, limit, cursor, options) {
         ...
         * @throws {RequiredError}
         */
        casts(apiKey, casts, viewerFid, sortType, options) {
...
class CastApi extends base_1.BaseAPI {
     ...
     */
    cast(apiKey, identifier, type, viewerFid, options) {
        return (0, exports.CastApiFp)(this.configuration).cast(apiKey, identifier, type, viewerFid, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Gets all casts related to a conversation surrounding a cast by passing in a cast hash or Warpcast URL. Includes all the ancestors of a cast up to the root parent in a chronological order. Includes all direct_replies to the cast up to the reply_depth specified in the query parameter.
     * @summary Retrieve the conversation for a given cast
     ...
     */
    castConversation(apiKey, identifier, type, replyDepth, includeChronologicalParentCasts, viewerFid, limit, cursor, options) {
        return (0, exports.CastApiFp)(this.configuration).castConversation(apiKey, identifier, type, replyDepth, includeChronologicalParentCasts, viewerFid, limit, cursor, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Retrieve multiple casts using their respective hashes.
     * @summary Gets information about an array of casts
     ...
     */
    casts(apiKey, casts, viewerFid, sortType, options) {
        return (0, exports.CastApiFp)(this.configuration).casts(apiKey, casts, viewerFid, sortType, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Delete an existing cast. \\ (In order to delete a cast `signer_uuid` must be approved)
     * @summary Delete a cast
     ...
     */
    deleteCast(apiKey, deleteCastReqBody, options) {
        return (0, exports.CastApiFp)(this.configuration).deleteCast(apiKey, deleteCastReqBody, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Posts a cast or cast reply. Works with mentions and embeds.   (In order to post a cast `signer_uuid` must be approved)
     * @summary Posts a cast
     ...
     */
    postCast(apiKey, postCastReqBody, options) {
        return (0, exports.CastApiFp)(this.configuration).postCast(apiKey, postCastReqBody, options).then((request) => request(this.axios, this.basePath));
    }
}
