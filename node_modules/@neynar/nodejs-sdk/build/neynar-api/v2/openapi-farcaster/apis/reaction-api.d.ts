...
export declare const ReactionApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    reactionsCast: (apiKey: string, hash: string, types: string, viewerFid?: number, limit?: number, cursor?: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    reactionsUser: (apiKey: string, fid: number, type: ReactionsType, viewerFid?: number, limit?: number, cursor?: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
};
/**
...
export declare const ReactionApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    reactionsCast(apiKey: string, hash: string, types: string, viewerFid?: number, limit?: number, cursor?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ReactionsCastResponse>>;
    /**
     * Fetches reactions for a given user
     * @summary Fetches reactions for a given user
     * @param {string} apiKey API key required for authentication.
     ...
     * @throws {RequiredError}
     */
    reactionsUser(apiKey: string, fid: number, type: ReactionsType, viewerFid?: number, limit?: number, cursor?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ReactionsResponse>>;
};
/**
...
export declare class ReactionApi extends BaseAPI {
     ...
     * @memberof ReactionApi
     */
    reactionsCast(apiKey: string, hash: string, types: string, viewerFid?: number, limit?: number, cursor?: string, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ReactionsCastResponse, any>>;
    /**
     * Fetches reactions for a given user
     * @summary Fetches reactions for a given user
     * @param {string} apiKey API key required for authentication.
     ...
     * @memberof ReactionApi
     */
    reactionsUser(apiKey: string, fid: number, type: ReactionsType, viewerFid?: number, limit?: number, cursor?: string, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ReactionsResponse, any>>;
}
