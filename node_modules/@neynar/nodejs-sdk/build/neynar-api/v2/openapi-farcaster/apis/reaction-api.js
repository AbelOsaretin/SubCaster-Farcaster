...
const ReactionApiAxiosParamCreator = function (configuration) {
    return {
         ...
         */
        deleteReaction: async (apiKey, reactionReqBody, options = {}) => {
            // verify required parameter 'apiKey' is not null or undefined
            (0, common_1.assertParamExists)('deleteReaction', 'apiKey', apiKey);
         ...
         * @throws {RequiredError}
         */
        postReaction: async (apiKey, reactionReqBody, options = {}) => {
            // verify required parameter 'apiKey' is not null or undefined
            (0, common_1.assertParamExists)('postReaction', 'apiKey', apiKey);
            // verify required parameter 'reactionReqBody' is not null or undefined
            (0, common_1.assertParamExists)('postReaction', 'reactionReqBody', reactionReqBody);
            const localVarPath = `/farcaster/reaction`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, common_1.DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        reactionsCast: async (apiKey, hash, types, viewerFid, limit, cursor, options = {}) => {
            // verify required parameter 'apiKey' is not null or undefined
            (0, common_1.assertParamExists)('reactionsCast', 'apiKey', apiKey);
            // verify required parameter 'hash' is not null or undefined
            (0, common_1.assertParamExists)('reactionsCast', 'hash', hash);
            // verify required parameter 'types' is not null or undefined
            (0, common_1.assertParamExists)('reactionsCast', 'types', types);
         ...
         * @throws {RequiredError}
         */
        reactionsUser: async (apiKey, fid, type, viewerFid, limit, cursor, options = {}) => {
            // verify required parameter 'apiKey' is not null or undefined
            (0, common_1.assertParamExists)('reactionsUser', 'apiKey', apiKey);
            // verify required parameter 'fid' is not null or undefined
            (0, common_1.assertParamExists)('reactionsUser', 'fid', fid);
            // verify required parameter 'type' is not null or undefined
            (0, common_1.assertParamExists)('reactionsUser', 'type', type);
...
const ReactionApiFp = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async deleteReaction(apiKey, reactionReqBody, options) {
         ...
         * @throws {RequiredError}
         */
        async postReaction(apiKey, reactionReqBody, options) {
         ...
         * @throws {RequiredError}
         */
        async reactionsCast(apiKey, hash, types, viewerFid, limit, cursor, options) {
         ...
         * @throws {RequiredError}
         */
        async reactionsUser(apiKey, fid, type, viewerFid, limit, cursor, options) {
...
const ReactionApiFactory = function (configuration, basePath, axios) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        reactionsCast(apiKey, hash, types, viewerFid, limit, cursor, options) {
         ...
         * @throws {RequiredError}
         */
        reactionsUser(apiKey, fid, type, viewerFid, limit, cursor, options) {
...
class ReactionApi extends base_1.BaseAPI {
     ...
     */
    deleteReaction(apiKey, reactionReqBody, options) {
        return (0, exports.ReactionApiFp)(this.configuration).deleteReaction(apiKey, reactionReqBody, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Post a reaction (like or recast) to a given cast \\ (In order to post a reaction `signer_uuid` must be approved)
     * @summary Posts a reaction
     ...
     */
    postReaction(apiKey, reactionReqBody, options) {
        return (0, exports.ReactionApiFp)(this.configuration).postReaction(apiKey, reactionReqBody, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Fetches reactions for a given cast
     * @summary Fetches reactions for a given cast
     ...
     */
    reactionsCast(apiKey, hash, types, viewerFid, limit, cursor, options) {
        return (0, exports.ReactionApiFp)(this.configuration).reactionsCast(apiKey, hash, types, viewerFid, limit, cursor, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Fetches reactions for a given user
     * @summary Fetches reactions for a given user
     ...
     */
    reactionsUser(apiKey, fid, type, viewerFid, limit, cursor, options) {
        return (0, exports.ReactionApiFp)(this.configuration).reactionsUser(apiKey, fid, type, viewerFid, limit, cursor, options).then((request) => request(this.axios, this.basePath));
    }
}
