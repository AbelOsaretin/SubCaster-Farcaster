...
export declare const ChannelApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    channelDetails: (apiKey: string, id: string, type?: ChannelType, viewerFid?: number, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    channelDetailsBulk: (apiKey: string, ids: string, type?: ChannelType, viewerFid?: number, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
...
export declare const ChannelApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    channelDetails(apiKey: string, id: string, type?: ChannelType, viewerFid?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ChannelResponse>>;
    /**
     * Returns details of multiple channels
     * @summary (Bulk) Retrieve channels by id or parent_url
     * @param {string} apiKey API key required for authentication.
     ...
     * @throws {RequiredError}
     */
    channelDetailsBulk(apiKey: string, ids: string, type?: ChannelType, viewerFid?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ChannelResponseBulk>>;
    /**
     * Returns a list of followers for a specific channel. Max limit is 1000. Use cursor for pagination.
     * @summary Retrieve followers for a given channel
     * @param {string} apiKey API key required for authentication.
...
export declare class ChannelApi extends BaseAPI {
     ...
     * @memberof ChannelApi
     */
    channelDetails(apiKey: string, id: string, type?: ChannelType, viewerFid?: number, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ChannelResponse, any>>;
    /**
     * Returns details of multiple channels
     * @summary (Bulk) Retrieve channels by id or parent_url
     * @param {string} apiKey API key required for authentication.
     ...
     * @memberof ChannelApi
     */
    channelDetailsBulk(apiKey: string, ids: string, type?: ChannelType, viewerFid?: number, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ChannelResponseBulk, any>>;
    /**
     * Returns a list of followers for a specific channel. Max limit is 1000. Use cursor for pagination.
     * @summary Retrieve followers for a given channel
     * @param {string} apiKey API key required for authentication.
