...
export declare const UserApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    powerUsers: (apiKey: string, viewerFid?: number, limit?: number, cursor?: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    userBulkByAddress: (apiKey: string, addresses: string, addressTypes?: string, viewerFid?: number, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
...
export declare const UserApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    powerUsers(apiKey: string, viewerFid?: number, limit?: number, cursor?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<UsersResponse>>;
    /**
     * Register account on farcaster.  **Note:** This API must be called within 10 minutes of the fetch fid API call (i.e., /v2/farcaster/user/fid). Otherwise, Neynar will assign this fid to another available user.
     * @summary Register account on farcaster
     * @param {string} apiKey API key required for authentication.
     ...
     * @throws {RequiredError}
     */
    userBulkByAddress(apiKey: string, addresses: string, addressTypes?: string, viewerFid?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<{
        [key: string]: User[];
    }>>;
    /**
     * Search for Usernames
...
export declare const UserApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
     ...
     * @throws {RequiredError}
     */
    userBulkByAddress(apiKey: string, addresses: string, addressTypes?: string, viewerFid?: number, options?: any): AxiosPromise<{
        [key: string]: User[];
    }>;
    /**
     * Search for Usernames
...
export declare class UserApi extends BaseAPI {
     ...
     * @memberof UserApi
     */
    powerUsers(apiKey: string, viewerFid?: number, limit?: number, cursor?: string, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<UsersResponse, any>>;
    /**
     * Register account on farcaster.  **Note:** This API must be called within 10 minutes of the fetch fid API call (i.e., /v2/farcaster/user/fid). Otherwise, Neynar will assign this fid to another available user.
     * @summary Register account on farcaster
     * @param {string} apiKey API key required for authentication.
     ...
     * @memberof UserApi
     */
    userBulkByAddress(apiKey: string, addresses: string, addressTypes?: string, viewerFid?: number, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<{
        [key: string]: User[];
    }, any>>;
    /**
     * Search for Usernames
