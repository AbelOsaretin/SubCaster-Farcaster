...
const FeedApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        feedChannels: async (apiKey, channelIds, withRecasts, viewerFid, withReplies, limit, cursor, shouldModerate, options = {}) => {
            // verify required parameter 'apiKey' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        feedForYou: async (apiKey, fid, viewerFid, provider, limit, cursor, options = {}) => {
            // verify required parameter 'apiKey' is not null or undefined
            (0, common_1.assertParamExists)('feedForYou', 'apiKey', apiKey);
            // verify required parameter 'fid' is not null or undefined
            (0, common_1.assertParamExists)('feedForYou', 'fid', fid);
...
const FeedApiFp = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async feedChannels(apiKey, channelIds, withRecasts, viewerFid, withReplies, limit, cursor, shouldModerate, options) {
         ...
         * @throws {RequiredError}
         */
        async feedForYou(apiKey, fid, viewerFid, provider, limit, cursor, options) {
...
const FeedApiFactory = function (configuration, basePath, axios) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        feedChannels(apiKey, channelIds, withRecasts, viewerFid, withReplies, limit, cursor, shouldModerate, options) {
         ...
         * @throws {RequiredError}
         */
        feedForYou(apiKey, fid, viewerFid, provider, limit, cursor, options) {
...
class FeedApi extends base_1.BaseAPI {
     ...
     */
    feedChannels(apiKey, channelIds, withRecasts, viewerFid, withReplies, limit, cursor, shouldModerate, options) {
        return (0, exports.FeedApiFp)(this.configuration).feedChannels(apiKey, channelIds, withRecasts, viewerFid, withReplies, limit, cursor, shouldModerate, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Retrieve feed based on who a user is following
     * @summary Retrieve feed based on who a user is following
     ...
     */
    feedForYou(apiKey, fid, viewerFid, provider, limit, cursor, options) {
        return (0, exports.FeedApiFp)(this.configuration).feedForYou(apiKey, fid, viewerFid, provider, limit, cursor, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Retrieve feed of casts with Frames, reverse chronological order
     * @summary Retrieve feed of casts with Frames, reverse chronological order
