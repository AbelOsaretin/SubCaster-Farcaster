...
const UserApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        powerUsers: async (apiKey, viewerFid, limit, cursor, options = {}) => {
            // verify required parameter 'apiKey' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        userBulkByAddress: async (apiKey, addresses, addressTypes, viewerFid, options = {}) => {
            // verify required parameter 'apiKey' is not null or undefined
...
const UserApiFp = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async powerUsers(apiKey, viewerFid, limit, cursor, options) {
         ...
         * @throws {RequiredError}
         */
        async userBulkByAddress(apiKey, addresses, addressTypes, viewerFid, options) {
...
const UserApiFactory = function (configuration, basePath, axios) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        powerUsers(apiKey, viewerFid, limit, cursor, options) {
         ...
         * @throws {RequiredError}
         */
        userBulkByAddress(apiKey, addresses, addressTypes, viewerFid, options) {
...
class UserApi extends base_1.BaseAPI {
     ...
     */
    powerUsers(apiKey, viewerFid, limit, cursor, options) {
        return (0, exports.UserApiFp)(this.configuration).powerUsers(apiKey, viewerFid, limit, cursor, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Register account on farcaster.  **Note:** This API must be called within 10 minutes of the fetch fid API call (i.e., /v2/farcaster/user/fid). Otherwise, Neynar will assign this fid to another available user.
     * @summary Register account on farcaster
     ...
     */
    userBulkByAddress(apiKey, addresses, addressTypes, viewerFid, options) {
        return (0, exports.UserApiFp)(this.configuration).userBulkByAddress(apiKey, addresses, addressTypes, viewerFid, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Search for Usernames
     * @summary Search for Usernames
