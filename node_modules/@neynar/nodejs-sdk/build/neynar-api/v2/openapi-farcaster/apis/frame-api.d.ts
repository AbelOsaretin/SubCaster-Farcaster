...
export declare const FrameApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    lookupNeynarFrame: (apiKey: string, type: FrameType, uuid?: string, url?: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
...
export declare const FrameApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    lookupNeynarFrame(apiKey: string, type: FrameType, uuid?: string, url?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<NeynarFrame>>;
    /**
     * Post a frame action \\ (In order to post a frame action, you need to have an approved `signer_uuid`)  The POST request to the post_url has a timeout of 5 seconds.
     * @summary Posts a frame action
     * @param {string} apiKey API key required for authentication.
...
export declare class FrameApi extends BaseAPI {
     ...
     * @memberof FrameApi
     */
    lookupNeynarFrame(apiKey: string, type: FrameType, uuid?: string, url?: string, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<NeynarFrame, any>>;
    /**
     * Post a frame action \\ (In order to post a frame action, you need to have an approved `signer_uuid`)  The POST request to the post_url has a timeout of 5 seconds.
     * @summary Posts a frame action
     * @param {string} apiKey API key required for authentication.
