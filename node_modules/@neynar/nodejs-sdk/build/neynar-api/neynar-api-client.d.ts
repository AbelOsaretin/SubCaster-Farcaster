import { Signer, Cast, CastParamType, PostCastResponseCast, ReactionType, OperationResponse, BulkFollowResponse, EmbeddedCast, FeedResponse, NotificationsResponse, RelevantFollowersResponse, UserSearchResponse, CastResponse, CastsResponse, UserResponse, BulkUsersResponse, FeedType, FilterType, ReactionsResponse, ReactionsType, StorageAllocationsResponse, StorageUsageResponse, ChannelResponse, ChannelListResponse, User as UserV2, BulkCastsResponse, FnameAvailabilityResponse, FrameAction, Frame, ValidateFrameActionResponse, UsersResponse, UsersActiveChannelsResponse, NeynarFrame, DeleteFrameResponse, NeynarFrameUpdateRequest, NeynarFrameCreationRequest, UserFIDResponse, RegisterUserResponse, DeveloperManagedSigner, WebhookResponse, WebhookSubscriptionFilters, WebhookListResponse, Conversation, ReactionsCastResponse, FrameValidateAnalyticsResponse, ValidateFrameAnalyticsType, FrameValidateListResponse, AuthorizationUrlResponse, AuthorizationUrlResponseType, TrendingChannelResponse, MuteListResponse, MuteResponse, FollowSortType, ChannelSearchResponse, ChannelType, ChannelResponseBulk, FrameType, SubscriptionProvider, SubscribersResponse, SubscribedToResponse, SubscriptionsResponse, SubscriptionProviders, ForYouProvider } from "./v2/openapi-farcaster";
import { RecentUsersResponse, UserCastLikeResponse, Cast as CastV1, CastsResponse as CastsResponseV1, RecentCastsResponse, MentionsAndRepliesResponse, ReactionsAndRecastsResponse, CastLikesResponse, CastReactionsResponse, CastRecasterResponse, FollowResponse, UserResponse as UserResponseV1, CustodyAddressResponse, CastResponse as CastResponseV1, VerificationResponse, AllCastsInThreadResponse } from "./v1/openapi";
...
export declare class NeynarAPIClient {
     ...
     */
    lookupUserByFid(fid: number, viewerFid?: number): Promise<UserResponseV1>;
    /**
     ...
     */
    lookupUserByUsername(username: string, viewerFid?: number): Promise<UserResponseV1>;
    /**
     * @deprecated
     * Now deprecated, use `fetchBulkUsers` instead.
     *
     ...
     */
    fetchAllCastsInThread(threadParent: CastV1 | string, viewerFid?: number): Promise<AllCastsInThreadResponse>;
    /**
     ...
     */
    lookupUserByVerification(address: string): Promise<UserResponseV1>;
    /**
     ...
     */
    fetchCastLikes(castOrCastHash: CastV1 | string, options?: {
        viewerFid?: number;
        limit?: number;
        cursor?: string;
     ...
     */
    fetchCastReactions(castOrCastHash: CastV1 | string, options?: {
        viewerFid?: number;
        limit?: number;
        cursor?: string;
     ...
     */
    fetchRecasters(castOrCastHash: CastV1 | string, options?: {
        viewerFid?: number;
        limit?: number;
        cursor?: string;
   ...
   */
    fetchAuthorizationUrl(client_id: string, response_type: AuthorizationUrlResponseType): Promise<AuthorizationUrlResponse>;
    /**
     ...
     */
    lookUpCastByHashOrWarpcastUrl(castHashOrUrl: string, type: CastParamType, options?: {
        viewerFid?: number;
     ...
     * For more information, refer to the [Neynar documentation](https://docs.neynar.com/reference/feed-following).
     */
    fetchFeedForYou(fid: number, options?: {
        limit?: number;
        cursor?: string;
        viewerFid?: number;
     ...
     */
    publishReactionToCast(signerUuid: string, reaction: ReactionType, castOrCastHash: Cast | string, options?: {
        idem?: string;
    }): Promise<OperationResponse>;
    /**
     ...
     */
    fetchReactionsForCast(hash: string, types: ReactionsType, options?: {
        limit?: number;
        cursor?: string;
        viewerFid?: number;
    ...
    /**
      ...
      */
    fetchBulkChannels(ids: string[], options?: {
        viewerFid?: number;
        type?: ChannelType;
  ...
  */
    fetchUserFollowersV2(fid: number, options?: {
        viewerFid?: number;
  ...
  */
    fetchUserFollowingV2(fid: number, options?: {
        viewerFid?: number;
        sortType: FollowSortType;
        cursor?: string;
        limit?: number;
     ...
     */
    lookupNeynarFrame(identifier: string, options?: {
        type?: FrameType;
    }): Promise<NeynarFrame>;
    /**
     ...
     */
    publishNeynarFrame(neynarFrameCreationRequest: NeynarFrameCreationRequest): Promise<NeynarFrame>;
    /**
     ...
     */
    updateNeynarFrame(neynarFrame: NeynarFrameUpdateRequest): Promise<NeynarFrame>;
    /**
     ...
     */
    deleteNeynarFrame(uuid: string): Promise<DeleteFrameResponse>;
    /**
     ...
     */
    fetchNeynarFrames(): Promise<NeynarFrame[]>;
    /**
     ...
     */
    postFrameAction(signerUuid: string, castHash: string, action: FrameAction): Promise<Frame>;
    /**
     ...
     * });
     */
    createSignerAndRegisterSignedKey(farcasterDeveloperMnemonic: string, options?: {
        deadline?: number;
    ...
    */
    ...
    /**
         ...
         */
    fetchSubscribersForFid(fid: number, subscriptionProvider: SubscriptionProviders, options?: {
        viewerFid?: number;
    ...
    /**
          ...
          */
    fetchSubscribedToForFid(fid: number, subscriptionProvider: SubscriptionProvider, options?: {
        viewerFid?: number;
    ...
    /**
           ...
           */
    fetchSubscriptionsForFid(fid: number, subscriptionProvider: SubscriptionProvider): Promise<SubscriptionsResponse>;
}
