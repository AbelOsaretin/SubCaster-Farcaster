...
const NotificationsApiAxiosParamCreator = function (configuration) {
    return {
         ...
         */
        mentionsAndReplies: async (apiKey, fid, viewerFid, cursor, options = {}) => {
            // verify required parameter 'apiKey' is not null or undefined
            (0, common_1.assertParamExists)('mentionsAndReplies', 'apiKey', apiKey);
         ...
         * @throws {RequiredError}
         */
        reactionsAndRecasts: async (apiKey, fid, viewerFid, limit, cursor, options = {}) => {
            // verify required parameter 'apiKey' is not null or undefined
            (0, common_1.assertParamExists)('reactionsAndRecasts', 'apiKey', apiKey);
            // verify required parameter 'fid' is not null or undefined
...
const NotificationsApiFp = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async mentionsAndReplies(apiKey, fid, viewerFid, cursor, options) {
         ...
         * @throws {RequiredError}
         */
        async reactionsAndRecasts(apiKey, fid, viewerFid, limit, cursor, options) {
...
const NotificationsApiFactory = function (configuration, basePath, axios) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        mentionsAndReplies(apiKey, fid, viewerFid, cursor, options) {
         ...
         * @throws {RequiredError}
         */
        reactionsAndRecasts(apiKey, fid, viewerFid, limit, cursor, options) {
...
class NotificationsApi extends base_1.BaseAPI {
     ...
     */
    mentionsAndReplies(apiKey, fid, viewerFid, cursor, options) {
        return (0, exports.NotificationsApiFp)(this.configuration).mentionsAndReplies(apiKey, fid, viewerFid, cursor, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Get a list of reactions and recasts to the users’s casts in reverse chronological order
     * @summary Get reactions and recasts
     ...
     */
    reactionsAndRecasts(apiKey, fid, viewerFid, limit, cursor, options) {
        return (0, exports.NotificationsApiFp)(this.configuration).reactionsAndRecasts(apiKey, fid, viewerFid, limit, cursor, options).then((request) => request(this.axios, this.basePath));
    }
}
