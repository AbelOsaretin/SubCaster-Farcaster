...
class NeynarV1APIClient {
    ...
    constructor(apiKey, { basePath, logger = logger_1.silentLogger, axiosInstance, } = {}) {
        ...
        this.apis = {
            ...
            reactions: new openapi_1.ReactionsApi(config, undefined, axiosInstance),
        };
    }
    /**
    ...
    async fetchRecentUsers(options) {
        const response = await this.apis.user.recentUsers(this.apiKey, options === null || options === void 0 ? void 0 : options.viewerFid, options === null || options === void 0 ? void 0 : options.limit, options === null || options === void 0 ? void 0 : options.cursor);
    ...
    async fetchAllCastsLikedByUser(fid, options) {
        const response = await this.apis.user.userCastLikes(this.apiKey, fid, options === null || options === void 0 ? void 0 : options.viewerFid, options === null || options === void 0 ? void 0 : options.limit, options === null || options === void 0 ? void 0 : options.cursor);
        return response.data;
    }
    /**
     * @deprecated
    ...
    async lookupUserByUsername(username, viewerFid) {
        const response = await this.apis.user.userByUsername(this.apiKey, username, viewerFid);
        return response.data;
    }
    /**
     * @deprecated
    ...
    async lookUpCastByHash(hash, options) {
        const response = await this.apis.cast.cast(this.apiKey, hash, options === null || options === void 0 ? void 0 : options.viewerFid);
        return response.data;
    }
    /**
     * @deprecated
    ...
    async fetchAllCastsInThread(threadParent, viewerFid) {
        ...
        const response = await this.apis.cast.allCastsInThread(this.apiKey, threadHash, viewerFid);
        return response.data;
    }
    /**
    ...
    async fetchAllCastsCreatedByUser(fid, options) {
        const response = await this.apis.cast.casts(this.apiKey, fid, options === null || options === void 0 ? void 0 : options.parentUrl, options === null || options === void 0 ? void 0 : options.viewerFid, options === null || options === void 0 ? void 0 : options.limit, options === null || options === void 0 ? void 0 : options.cursor);
        return response.data;
    }
    /**
    ...
    async fetchRecentCasts(options) {
        const response = await this.apis.cast.recentCasts(this.apiKey, options === null || options === void 0 ? void 0 : options.viewerFid, options === null || options === void 0 ? void 0 : options.limit, options === null || options === void 0 ? void 0 : options.cursor);
        return response.data;
    }
    // ------------ Verification ------------
    /**
    ...
    async fetchUserVerifications(fid) {
        const response = await this.apis.verification.verifications(this.apiKey, fid);
        return response.data;
    }
    /**
     * @deprecated
    ...
    async lookupUserByVerification(address) {
        const response = await this.apis.verification.userByVerification(this.apiKey, address);
        return response.data;
    }
    // ------------ Notifications ------------
    /**
    ...
    async fetchMentionAndReplyNotifications(fid, options) {
        const response = await this.apis.notifications.mentionsAndReplies(this.apiKey, fid, options === null || options === void 0 ? void 0 : options.viewerFid, options === null || options === void 0 ? void 0 : options.cursor);
        return response.data;
    }
    /**
    ...
    async fetchUserLikesAndRecasts(fid, options) {
        const response = await this.apis.notifications.reactionsAndRecasts(this.apiKey, fid, options === null || options === void 0 ? void 0 : options.viewerFid, options === null || options === void 0 ? void 0 : options.limit, options === null || options === void 0 ? void 0 : options.cursor);
        return response.data;
    }
    // ------------ Reactions ------------
    /**
     ...
     */
    async fetchCastLikes(castOrCastHash, options) {
        let castHash;
        ...
        const response = await this.apis.reactions.castLikes(this.apiKey, castHash, options === null || options === void 0 ? void 0 : options.viewerFid, options === null || options === void 0 ? void 0 : options.limit, options === null || options === void 0 ? void 0 : options.cursor);
        return response.data;
    }
    /**
     * @deprecated
     ...
     */
    async fetchCastReactions(castOrCastHash, options) {
        let castHash;
        if (typeof castOrCastHash === "string") {
            castHash = castOrCastHash;
        }
        ...
        const response = await this.apis.reactions.castReactions(this.apiKey, castHash, options === null || options === void 0 ? void 0 : options.viewerFid, options === null || options === void 0 ? void 0 : options.limit, options === null || options === void 0 ? void 0 : options.cursor);
        return response.data;
    }
    /**
     * @deprecated
     ...
     */
    async fetchRecasters(castOrCastHash, options) {
        let castHash;
        if (typeof castOrCastHash === "string") {
            castHash = castOrCastHash;
        }
        ...
        const response = await this.apis.reactions.castRecasters(this.apiKey, castHash, options === null || options === void 0 ? void 0 : options.viewerFid, options === null || options === void 0 ? void 0 : options.limit, options === null || options === void 0 ? void 0 : options.cursor);
        return response.data;
    }
    // ------------ Follows ------------
    /**
    ...
    async fetchUserFollowers(fid, options) {
        const response = await this.apis.follows.followers(this.apiKey, fid, options === null || options === void 0 ? void 0 : options.viewerFid, options === null || options === void 0 ? void 0 : options.limit, options === null || options === void 0 ? void 0 : options.cursor);
        return response.data;
    }
    /**
    ...
    async fetchUserFollowing(fid, options) {
        const response = await this.apis.follows.following(this.apiKey, fid, options === null || options === void 0 ? void 0 : options.viewerFid, options === null || options === void 0 ? void 0 : options.limit, options === null || options === void 0 ? void 0 : options.cursor);
        return response.data;
    }
}
