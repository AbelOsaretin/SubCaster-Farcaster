import { Cast, CastApi, UserApi, VerificationApi, NotificationsApi, ReactionsApi, FollowsApi, ErrorRes, RecentUsersResponse, RecentCastsResponse, UserCastLikeResponse, CastsResponse, MentionsAndRepliesResponse, ReactionsAndRecastsResponse, CastLikesResponse, CastReactionsResponse, CastRecasterResponse, FollowResponse, UserResponse, CustodyAddressResponse, CastResponse, VerificationResponse, AllCastsInThreadResponse } from "./openapi";
...
export declare class NeynarV1APIClient {
     ...
     */
    fetchCastLikes(castOrCastHash: Cast | string, options?: {
        viewerFid?: number;
        limit?: number;
        cursor?: string;
     ...
     */
    fetchCastReactions(castOrCastHash: Cast | string, options?: {
        viewerFid?: number;
        limit?: number;
        cursor?: string;
     ...
     */
    fetchRecasters(castOrCastHash: Cast | string, options?: {
        viewerFid?: number;
        limit?: number;
        cursor?: string;
