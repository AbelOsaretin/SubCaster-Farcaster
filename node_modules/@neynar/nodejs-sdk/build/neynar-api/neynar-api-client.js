...
class NeynarAPIClient {
    ...
    constructor(apiKey, { basePath, logger = logger_1.silentLogger, axiosInstance, } = {}) {
        ...
        this.clients = {
            v1: new v1_1.NeynarV1APIClient(apiKey, { basePath, logger, axiosInstance }),
            v2: new v2_1.NeynarV2APIClient(apiKey, { basePath, logger, axiosInstance }),
        };
    }
    // ============ v1 APIs ============
    // ------------ User ------------
    ...
    async fetchMentionAndReplyNotifications(fid, options) {
        return await this.clients.v1.fetchMentionAndReplyNotifications(fid, options);
    }
    /**
   ...
   */
    async fetchAuthorizationUrl(client_id, response_type) {
        return await this.clients.v2.fetchAuthorizationUrl(client_id, response_type);
    }
    /**
    ...
    async registerSignedKey(signerUuid, fid, deadline, signature) {
        return await this.clients.v2.registerSignedKey(signerUuid, fid, deadline, signature);
    }
    ...
    async registerSignedKeyForDeveloperManagedSigner(publicKey, signature, appFid, deadline) {
        return await this.clients.v2.registerSignedKeyForDeveloperManagedSigner(publicKey, signature, appFid, deadline);
    }
    /**
    ...
    async registerAccount(fid, signature, requested_user_custody_address, deadline, options) {
        return await this.clients.v2.registerAccount(fid, signature, requested_user_custody_address, deadline, options);
    }
    /**
    ...
    async publishVerification(signerUuid, address, blockHash, ethSignature) {
        return await this.clients.v2.publishVerification(signerUuid, address, blockHash, ethSignature);
    }
    /**
    ...
    async fetchBulkUsersByEthereumAddress(addresses, options) {
        return await this.clients.v2.fetchBulkUsersByEthereumAddress(addresses, options);
    }
    /**
    ...
    async lookupCastConversation(castHashOrUrl, type, options) {
        return await this.clients.v2.lookupCastConversation(castHashOrUrl, type, options);
    }
    /**
    ...
    async lookUpCastByHashOrWarpcastUrl(castHashOrUrl, type, options) {
        return await this.clients.v2.lookUpCastByHashOrWarpcastUrl(castHashOrUrl, type, options);
    }
    /**
    ...
    async publishReactionToCast(signerUuid, reaction, castOrCastHash, options) {
        return await this.clients.v2.publishReactionToCast(signerUuid, reaction, castOrCastHash, options);
    }
    /**
    ...
    async deleteReactionFromCast(signerUuid, reaction, castOrCastHash) {
        return await this.clients.v2.deleteReactionFromCast(signerUuid, reaction, castOrCastHash);
    }
    /**
     ...
     */
    async fetchReactionsForCast(hash, types, options) {
    ...
    async fetchChannelNotificationsForUser(fid, channelIds, options) {
        return await this.clients.v2.fetchChannelNotificationsForUser(fid, channelIds, options);
    }
    // ------------ Channel ------------
    /**
    ...
    async fetchActiveUsersInSingleChannel(id, hasRootCastAuthors, options) {
        return await this.clients.v2.fetchActiveUsersInSingleChannel(id, hasRootCastAuthors, options);
    }
    /**
    ...
    async fetchNotificationsByParentUrlForUser(fid, parentUrls, options) {
        return await this.clients.v2.fetchNotificationsByParentUrlForUser(fid, parentUrls, options);
    }
    /**
  ...
  */
     ...
     */
    async updateNeynarFrame(neynarFrame) {
    ...
    async validateFrameAction(messageBytesInHex, options) {
        return await this.clients.v2.validateFrameAction(messageBytesInHex, options);
    }
    /**
    ...
    async fetchValidateFrameAnalytics(frameUrl, analyticsType, start, stop, options) {
        return await this.clients.v2.fetchValidateFrameAnalytics(frameUrl, analyticsType, start, stop, options);
    }
    // ------------ Webhook ------------
    /**
    ...
    async fetchRelevantMints(address, contractAddress, options) {
        return await this.clients.v2.fetchRelevantMints(address, contractAddress, options);
    }
     ...
     * });
     */
    async createSignerAndRegisterSignedKey(farcasterDeveloperMnemonic, options) {
        var _a;
        try {
            ...
            const { user: farcasterDeveloper } = await this.lookupUserByCustodyAddress(account.address);
            // Generates an expiration date for the signature
            // e.g. 1693927665
            const signed_key_deadline = (_a = options === null || options === void 0 ? void 0 : options.deadline) !== null && _a !== void 0 ? _a : Math.floor(Date.now() / 1000) + 86400; // signature is valid for 1 day from now
